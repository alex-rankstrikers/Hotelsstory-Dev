...
function MyHeader(props) {
  ...
  const drawer = (
    <div className={classes.MobileBg} display="flex">
      ...
      <Divider className={classes.dividercolor} />
      <List className={classes.lastMenuItem}>
        <ListItem button className={classes.listItemCSS}>
          ...
          <Toolbar className="p-l-0 p-r-0">
            ...
            <div className={classes.sectionDesktop}>
              <Typography className={classes.menuLink}>
                <Link href="/" color="inherit" underline="none" className={`${classes.menuItems} ${classes.menuItemsActive}`}>
                  <HotelIcon />
                ...
                <Link href="offers" color="inherit" underline="none" className={`${classes.menuItems}`}>
